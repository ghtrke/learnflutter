...
//
// 问题
//    - 使用 drift 实现原有逻辑，调试程序
//    - 阅读理解代码的能力，例如，深入了解 drift 的实现方式，尤其是 database connection 的处理
//      - 从顶层类的设计开始，猜测其中的成员设计意图，逐步深挖，还可以借助调试定位代码调用路径
//    - 针对一个问题，进行深挖，例如 ORM, 需要了解其历史和发展，想要解决的问题，等等，而不是停留在表面
//    - 封装 database 到一个单例中用于访问
//    - 模式
...
//    - 研究 drift 的 appdatabase 如何管理 database connection
//    - 研究数据库测试的合理测试方式：mock, 结合之前研究的单元测试的原则
//    - 领域驱动设计: aggregate, factory, repository
//    - ORM 解决了什么问题，什么场景下适合使用 ORM?
